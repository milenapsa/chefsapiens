...
http.createServer(async (req, res) => {
  try {
    ...
    res.end(fs.readFileSync(path.join(process.cwd(), hit[0])));
  } catch (error) {
  ...
  console.log("ADMIN_READY 8082 version=2.0 pipeline=true editable=true audit=true originGuard=true leadValidation=true serializedWrites=true");
});